# The Power vs. Mid-Major Gap in College Football: Competitive Balance, Revenue, and Recruiting
...
As revenue sharing reshapes how programs fund rosters, is the on-field and financial gap between power and mid-major programs widening, holding steady, or narrowing? Does recruiting behavior show the same pattern?
...
## Methodologies - START HERE
The following steps were implemented in Python (pandas, `cfbd` API client) in Google Colab, plus a supplementary Excel workbook for the revenue/competitive-balance tie-out:
1. Team/conference tier classification, with manual handling of realignment edge cases (Pac-12 = power through 2023, mid-major from 2024; independents Notre Dame = power, UConn = mid-major; BYU = mid-major in 2022 only, power from 2023 in the Big 12)
2. Win percentage and postseason (bowl/CFP) appearance rate computed per team-season, then averaged by tier and year
3. Tier-level revenue and expense medians merged in by year from the Knight-Newhouse database
4. Gap metrics (power minus mid-major) computed year-over-year for win percentage, bowl rate, and revenue, with 2025 compared against the 2022–24 average as the pre-settlement baseline
5. Groupby/pivot aggregation of recruiting class composition by star rating and tier, by year
6. Groupby/pivot aggregation of transfer portal flow by origin tier → destination tier, by year
7. Percentage-share and gap calculations (power minus mid-major share) for recruiting, by year
8. Visualization of all trends 2022–2026, with 2025 (competitive balance/revenue) and 2026 (recruiting) flagged as the first data points under revenue-sharing

---

## Key Findings
### 1. The Win Percentage Gap Has Stayed Remarkably Stable — Including Through the First Revenue-Share Season
* Power programs' average win percentage held in a tight band, 56.3%–56.7%, across all four seasons; mid-major programs averaged 47.6%–48.2%
* The resulting gap barely moved: 8.1 points (2022) → 8.7 (2023) → 8.9 (2024) → 8.7 points (2025) — no meaningful shift from the 2022–24 average (8.6 points) in the first revenue-sharing season

---

### 2. The Bowl/CFP Appearance Rate Gap Widened for Three Years, Then Nearly Vanished in 2025
* The bowl-rate gap grew from 13.2 points (2022) to 13.4 (2023) to a four-year high of 19.1 points (2024)
* It then collapsed to just 2.9 points in 2025 — power programs' bowl rate fell from 70.6% to 61.8% while mid-major's rose from 51.5% to 58.8%
* That's a sharper single-year move than anything in the three prior seasons — though bowl rate is a small-sample, binary metric (most teams play in at most one postseason game), so it's noisier than win percentage and worth re-checking against a second data point before calling it a trend
...
* The dollar gap between tiers grew from $109.7M (2024) to $130.1M (2025) — its largest single-year jump in the dataset — and power's share of combined tier revenue also ticked up, from 77.8% to 78.7%

---

### 4. Year One of Revenue Sharing: The Financial Gap Grew, the Competitive Gap Didn't (Yet)
* Despite the largest financial-gap increase in the four-year window, 2025 didn't produce a wider competitive gap: the win percentage gap barely moved and the bowl-rate gap narrowed sharply
* One post-settlement season isn't enough to call this a trend — it's an early signal that money and on-field competitiveness aren't moving in lockstep yet, worth re-checking after the 2026 season
...
* The most popular transfer destinations change year to year and mix power and mid-major programs — e.g., Colorado, Louisville, and Purdue (power) alongside Texas State (mid-major) all appear among the top destinations in a given year
...
* Movement between power programs also grew substantially, from 515 to 837 3+ star transfers — signaling intensifying internal competition for talent at the top
* Power-to-mid-major transfers rose too, from 310 (2023) to 499 (2026), peaking at 527 in 2025
...
* Isolating 3-star recruits specifically: mid-major's share rose 9.5 points (34.0% → 43.5%) while power's fell 7.8 points (44.1% → 36.3%)
...
* Mid-major programs signed zero 5-star recruits in any year, 2023–2026
* The gap narrowing seen in Finding 8 is driven entirely by 3-star talent — the top of the recruiting board hasn't moved
...
* The sharp narrowing in bowl-rate gap in 2025 is an encouraging signal, but it arrived in the same year the revenue gap widened the most — financial ground is not (yet) being lost proportionally on the field
* The 4-/5-star recruiting tier remains structurally closed — competing there isn't realistic without a change in resources, not just a change in NCAA rules
...
### For Analytics and Front-Office Teams
* The mismatch between the widening financial gap and the flat competitive gap in 2025 is a useful reminder that revenue and on-field performance don't move in lockstep in the short term
